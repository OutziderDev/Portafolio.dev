...
export const proyectos: Proyecto[] = [
    ...
    },
    {
      ...
      "descripcion": "Desarrollo de la landing page de La Velada del Año V, el evento icónico del streamer Ibai Llanos. Se trata de un proyecto de código abierto de Midudev, donde los desarrolladores y diseñadores pueden aportar ideas y mejoras durante su desarrollo.",
    ...
    },
    {
      ...
      "descripcion": "Portafolio digital donde presento mi experiencia en el desarrollo de software, mis habilidades y proyectos de forma profesional. También incluyo información sobre mí, enlaces a mis proyectos, entre otros",
